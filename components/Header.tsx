    ...
    <header className="flex justify-between mb-8">
      ...
      <div>
        <nav className="text-slate-600 dark:text-slate-300">
          ...
          {session && (
            <>
              <Link href="/entries/new" className="mx-5">
                <button className="font-semibold text-white text-sm bg-gradient-to-r from-indigo-400 via-purple-400 to-cyan-400 hover:from-indigo-500 hover:via-purple-500 hover:to-cyan-500 rounded-md px-3 py-2">New Entry</button>
              </Link>
